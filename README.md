...
Zusätzlich finden sich die Daten zu den Ergebnissen im Ordner "Ergebnisse". Der Ordner beinhaltet folgende Dateien:
1. Topic_Model_Final_groß
2. Topic_Model_Final_kompakt
3. Nutzerdaten
4. Zeitliche_Analyse
